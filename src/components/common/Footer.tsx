...
import { Leaf, Instagram, Play, ArrowRight } from "lucide-react";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          <div className="space-y-6">
            <Link href="/" className="flex items-center gap-2.5">
              ...
              <span className="text-2xl font-extrabold tracking-tight">Mart<span className="text-brand-primary">Fresh</span></span>
            </Link>
